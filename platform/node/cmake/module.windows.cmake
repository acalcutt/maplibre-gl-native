...
function(add_node_module NAME)
    ...
    if(NOT EXISTS "${_CACHE_DIR}/include/node/index.tab")
        _node_module_download(
            "Node.js version list"
            "https://nodejs.org/dist/index.tab"
            "${_CACHE_DIR}/include/node/index.tab"
        )
    endif()
    file(STRINGS "${_CACHE_DIR}/include/node/index.tab" _INDEX_FILE)
    ...
    # Install Nan
    if(_NAN_VERSION AND NOT EXISTS "${_CACHE_DIR}/include/nan/${_NAN_VERSION}/nan.h")
        _node_module_unpack_tar_gz(
            "Nan ${_NAN_VERSION}"
            "https://registry.npmjs.org/nan/-/nan-${_NAN_VERSION}.tgz"
            "package"
            "${_CACHE_DIR}/include/nan/${_NAN_VERSION}"
        )
    endif()
    ...
    foreach(_ABI IN LISTS _ABIS)
        ...
        if(NOT EXISTS "${_CACHE_DIR}/include/node/${_NODE_VERSION}/node.h")
            _node_module_unpack_tar_gz(
                ...
                "${_CACHE_DIR}/include/node/${_NODE_VERSION}"
            )
        endif()
